...
export default function AdminLoginPage() {
  ...
  return (
    <main className="flex min-h-dvh items-center justify-center px-5 pt-20">
      <form
        onSubmit={submit}
        className="liquid-glass w-full max-w-sm px-7 py-8"
      >
        ...
        <label
          htmlFor="admin-email"
          className="mt-6 block text-xs font-bold uppercase tracking-[0.16em] opacity-60"
        >
          Email
        </label>
        <input
        ...
        <label
          ...
          className="mt-4 block text-xs font-bold uppercase tracking-[0.16em] opacity-60"
        >
          Password
        </label>
        <input
