  ...
  return {
    ...
    icons: {
      icon: [
        ...
        {
          url: customIcons.i48 || "/icon.png",
          type: "image/png",
          sizes: "48x48",
        },
        {
          url: customIcons.i192 || "/icon-192.png",
          type: "image/png",
          sizes: "192x192",
        },
        {
          url: customIcons.i512 || "/icon-512.png",
          type: "image/png",
          sizes: "512x512",
        },
      ],
      apple: [
        { url: customIcons.apple || "/apple-touch-icon.png", sizes: "180x180" },
      ],
    },
    openGraph: {
      type: "website",
    ...
    <html lang="en" className="dark" suppressHydrationWarning>
      ...
      <body
        className={
          ...
          " " +
          manrope.variable +
          " font-body bg-ink-950 text-bone-100 dark:bg-ink-950 dark:text-bone-100"
        }
      >
        <div className="min-h-dvh bg-bone-50 text-ink-900 dark:bg-ink-950 dark:text-bone-100">
          ...
          <Footer
            ...
            menu={
              cms.menus && Array.isArray(cms.menus.footer)
                ? cms.menus.footer
                : []
            }
